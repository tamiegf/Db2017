...
class categoryDAO:
    ...
    def insert(self, cname, cdescription, rid):
        cursor = self.conn.cursor()
        query = "insert into resource_category(cname, cdescription, rid) values (%s, %s, %s) returning cid;"
        cursor.execute(query, (cname, cdescription, rid,))
